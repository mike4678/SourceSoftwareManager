...
<div class="row">
	<div class="col-lg-4 col-md-6 col-xs-12">
    	<div class="box-content">
            	<div class="box-title"><strong>关于我们</strong></div>
				<table class="table">
                    ...
                    <tr><td width="110" align="right">技术参考：</td><td>界面：NinjaAdmin</a><br >探针：<a href="http://www.yahei.net/tz/" target="_blank">雅黑系统探针</a><br >上传：<a href="https://www.helloweba.com/view-blog-189.html" target="_blank">Helloweba</a><td></tr>
                </table>
            <br />
        </div>
	</div>
        <div class="col-lg-8 col-md-6 col-xs-12">
            <div class="box-content">
           	  <div class="box-title"><strong>系统参数</strong></div>
              <table class="table">
                    ...
                    <td colspan="2" align="right"><a href='index.php?/system/info'>More...</a></td>
                    </tr>
                </table>
            </div>
        </div>
