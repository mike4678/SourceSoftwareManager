...
public class rg_n21609 extends android.view.View {
    ...
    public rg_n21609(Context context) {
        this(context, null);
    }
    public rg_n21609(Context context, AttributeSet set) {
        this(context, set, -1);
    }
    public rg_n21609(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, source.SoftwareManagerAndroid.R.styleable.UserGuideView);
            highLightStyle = array.getInt(source.SoftwareManagerAndroid.R.styleable.UserGuideView_HighlightViewStyle, VIEWSTYLE_RECT);
            maskblurstyle = array.getInt(source.SoftwareManagerAndroid.R.styleable.UserGuideView_MaskBlurStyle, MASKBLURSTYLE_SOLID);
            BitmapDrawable drawable = (BitmapDrawable) array.getDrawable(source.SoftwareManagerAndroid.R.styleable.UserGuideView_tipView);
            maskColor = array.getColor(source.SoftwareManagerAndroid.R.styleable.UserGuideView_maskColor, maskColor);
            if (drawable != null) {
                tipBitmap = drawable.getBitmap();
            }
            BitmapDrawable jtUpCenter = (BitmapDrawable) array.getDrawable(source.SoftwareManagerAndroid.R.styleable.UserGuideView_indicator_arrow_up_center);
            BitmapDrawable jtUpLeft = (BitmapDrawable) array.getDrawable(source.SoftwareManagerAndroid.R.styleable.UserGuideView_indicator_arrow_up_left);
            BitmapDrawable jtUpRight = (BitmapDrawable) array.getDrawable(source.SoftwareManagerAndroid.R.styleable.UserGuideView_indicator_arrow_up_right);
            BitmapDrawable jtDownCenter = (BitmapDrawable) array.getDrawable(source.SoftwareManagerAndroid.R.styleable.UserGuideView_indicator_arrow_down_center);
            BitmapDrawable jtDownLeft = (BitmapDrawable) array.getDrawable(source.SoftwareManagerAndroid.R.styleable.UserGuideView_indicator_arrow_down_left);
            BitmapDrawable jtDownRight = (BitmapDrawable) array.getDrawable(source.SoftwareManagerAndroid.R.styleable.UserGuideView_indicator_arrow_down_right);
            if (jtUpCenter != null) {
                this.jtUpCenter = jtUpCenter.getBitmap();
            } else {
                this.jtUpCenter = BitmapFactory.decodeResource(getResources(), source.SoftwareManagerAndroid.R.drawable.jt_up_center);
            }
            if (jtUpLeft != null) {
                this.jtUpLeft = jtUpLeft.getBitmap();
            } else {
                this.jtUpLeft = BitmapFactory.decodeResource(getResources(), source.SoftwareManagerAndroid.R.drawable.jt_up_left);
            }
            if (jtUpRight != null) {
                this.jtUpRight = jtUpRight.getBitmap();
            } else {
                this.jtUpRight = BitmapFactory.decodeResource(getResources(), source.SoftwareManagerAndroid.R.drawable.jt_up_right);
            }
            if (jtDownCenter != null) {
                this.jtDownCenter = jtDownCenter.getBitmap();
            } else {
                this.jtDownCenter = BitmapFactory.decodeResource(getResources(), source.SoftwareManagerAndroid.R.drawable.jt_down_center);
            }
            if (jtDownLeft != null) {
                this.jtDownLeft = jtDownLeft.getBitmap();
            } else {
                this.jtDownLeft = BitmapFactory.decodeResource(getResources(), source.SoftwareManagerAndroid.R.drawable.jt_down_left);
            }
            if (jtDownRight != null) {
                this.jtDownRight = jtDownRight.getBitmap();
            } else {
                this.jtDownRight = BitmapFactory.decodeResource(getResources(), source.SoftwareManagerAndroid.R.drawable.jt_down_right);
            }
            array.recycle();
        }
        cal(context);
    ...
    public void setHighLightView(hsh.anzh.jb.AndroidView...targetView) {
        if (targetView != null) {
            ...
            if (touchOutsideCancel) {
                if (targetViews == null || targetViews.size() == 0) {
                    ...
                    if (this.onDismissListener != null) {
                        onDismissListener.onDismiss(rg_n21609.this);
                    }
                } else {
                    tipBitmap = getBitmapFromResId(tipViews.get(0));
                    tipViews.remove(0);
    ...
    public interface OnDismissListener {
        public void onDismiss(rg_n21609 userGuideView);
    }
